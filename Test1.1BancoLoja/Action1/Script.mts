...
Browser("Banco de Loja > Home").Page("Banco de Loja > Herramientas").WebEdit("dnn$ctr806$View$txtAmount").Set DataTable("data_inversion", dtGlobalSheet) @@ script infofile_;_ZIP::ssf3.xml_;_
...
Browser("Banco de Loja > Home").Page("Banco de Loja > Herramientas").WebElement("$5362.67").Check CheckPoint("$5362.67") @@ script infofile_;_ZIP::ssf6.xml_;_
